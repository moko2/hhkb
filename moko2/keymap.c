...
//void ctrl_plus(uint8_t, uint8_t, keyrecord_t);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_WIN] = LAYOUT_JP(
        ...
        MO(_FN), KC_ZKHK, KC_LGUI, KC_LALT, KC_SMHEN, KC_SSWIN, KC_SHENK, KC_KANA, KC_RALT, MO(_FN), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_UNIX] = LAYOUT_JP(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RO, KC_UP, KC_RSFT,
        MO(_FN), KC_ZKHK, KC_LGUI, KC_LALT, KC_SMHEN, KC_SSUNI, KC_SHENK, KC_KANA, KC_RALT, MO(_FN), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_ORG] = LAYOUT_JP(
        ...
        KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_BSLS, KC_ENT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RO, KC_UP, KC_RSFT,
        MO(_FN), KC_ZKHK, KC_LGUI, KC_LALT, KC_MHEN, KC_SPC, KC_HENK, KC_KANA, KC_RALT, MO(_FN), KC_LEFT, KC_DOWN, KC_RGHT),
   ...
   [_EDWIN] = LAYOUT_JP(
        ...
        _______, _______, LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), _______, _______, KC_HOME, M(UM_SLEFT), M(UM_SRGHT), KC_END, _______, _______, _______,
    ...
    [_EDUNI] = LAYOUT_JP(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_HOME, M(UM_SLEFT), M(UM_SRGHT), KC_END, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
    ...
    [_MOUSE] = LAYOUT_JP(
        ...
        _______, _______, _______, _______, _______, KC_BTN1, _______, _______, _______, _______, _______, _______, _______),
